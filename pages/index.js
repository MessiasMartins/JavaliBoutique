    ...
    <>
        ...
        <div className="relative z-10 pb-8 bg-white dark:bg-gray-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            ...
            <h1 className="text-3xl pt-10 font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
                ...
                <span className="block text-primary-500 hover:text-primary-600 dark:hover:text-primary-400 xl:inline"> atual Projeto!</span>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              O Know How de mais de 30 anos de experiência no setor 
              madeireiro aliado a uma administração dinâmica e atendimento intimista.<br></br><br></br>Conte conosco!</p>
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href="#"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-900 bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10"
                  >
                    E-Mail
                  </a>
                </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative">
                <dt>
                  ...
                  <p className="text-center text-2xl font-extrabold  pb-2 leading-7 text-gray-100">{feature.name}</p>
                </dt>
                <dd className="text-center text- text-lg font-medium pb-2 leading-7 text-gray-100">{feature.description}</dd>
              </div>
            ))}
          </dl>
         </div>
      ...
      <div className="#">
        ...
        <p className="text-lg text-gray-500 dark:text-gray-400">
          Avenida Portugal 901A - Santa Amélia, Belo Horizonte / Minas Gerais <br></br> 
          CEP: 31550-000 <br></br>
